    ...
    <div className="px-gutter py-space-lg">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="bg-surface-pure rounded-2xl shadow-sm p-space-xl">
          <p className="font-body-lg text-body-lg text-on-surface-variant mb-space-lg">Add problem, solution, and target users for your venture.</p>
          <button onClick={() => router.back()} className="inline-flex items-center gap-2 h-11 px-6 bg-navy-deep text-on-primary font-label-md text-label-md rounded-xl">
            Back
          </button>
        </div>
      </div>
